        ...
        public ActionResult CompletePayout(int sortID)
        {
            using (TrailerEntities db = new TrailerEntities())
            {
                ...
                if (payout.Vendor != null)
                {
                    ...
                    body = "Ginger,<br><br> " + "A new completed payout was created for " + vendor + "<br><br> <a href=\"trailermanagement.palletusa.local/PalletRepair/ViewCompletedPayout?sortID=" + sortID.ToString() + "\"> Click to view </a>";
                }
